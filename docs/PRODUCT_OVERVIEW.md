...
**484 vulnerabilities fixed** across 12 dedicated audit passes (including external Strix.ai pentest),
...
**Test coverage**: 830 C++ tests + 35 Python tests + 10 Rust tests + 11 fuzz harnesses +
...
Build with `-DSIGNET_BUILD_AI_AUDIT=OFF` to exclude the AGPL-3.0+ audit tier entirely.
