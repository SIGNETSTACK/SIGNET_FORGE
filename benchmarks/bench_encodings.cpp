...
TEST_CASE("Encoding: RLE boolean flags — encode 10K bits", "[encoding][rle][bench]") {
    ...
    BENCHMARK("rle encode bit_width=1") {
        return RleEncoder::encode(flags.data(), N, 1);
    };

    BENCHMARK("rle decode bit_width=1") {
